      ...
      <div className="flex gap-1 sm:gap-2 w-fit mx-auto items-center">
        {actions.map((action) => (
          <a
            key={action.name}
            href={action.href}
            className="flex border-b-4 border-purple-900/50 items-center gap-2 px-3 sm:px-4 py-2 rounded-md font-bold text-white bg-gradient-to-r from-purple-600 to-pink-600 shadow-xl hover:from-pink-500 hover:to-purple-500 hover:shadow-purple-500/25 transition-all duration-200 text-xs sm:text-sm active:scale-95"
        ...
        <button
          ...
          className="flex items-center border-b-4 border-red-900 gap-2 px-3 sm:px-4 py-2 rounded-md font-bold text-white bg-gradient-to-r from-red-600 to-pink-600 shadow-xl hover:from-pink-700 hover:to-red-500 hover:shadow-red-500/25 transition-all duration-200 text-xs sm:text-sm active:scale-95"
          style={{ minWidth: 90, justifyContent: "center" }}
        >
